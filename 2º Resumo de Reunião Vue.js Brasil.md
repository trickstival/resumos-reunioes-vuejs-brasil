...
- ## Lives
  ...
  - ### Estilo das lives -> 
    - Free-talk/Q&A ->
      - Serão feitos de preferência quando não planejarmos falar sobre algum assunto mais técnico
      - Iremos falar sobre novidades no mundo Vue.js
    - Entrevistas
    - Dinamicidade
    - Os anfitriões alternarão de acordo com a disponibilidade
  - ### Posteriormente de 15 em 15 dias haverá alternância na forma das lives (de Q&A/Free-talk para entrevista ou para abordagem técnica)

- ## VueWeek
  - ### Está sendo planejada para ocorrer em Janeiro
  - ### Podemos traduzir as legendas dos convidados internacionais para o português posteriormente
    - Deixaremos em aberto para a comunidade legendar também
  - ### Pessoas sugeridas -> Quem irá atrás
    - Vedovelli (Abertura) -> Vinicius
    - Chopin (Nuxt.js) -> ktquez
    - Razvan Stoenescu (Quasar Framework) -> Vinicius
    - POSVA (Core-team) -> trickstival
    - Marcos Moura (Vue-material BR) -> Tiago
    - Rafael Beraldo (Buefy) -> Anterio
    - Igor Randjelovic (NativeScript + Vue) -> Tiago

- ## O prazo para a entrega do material bruto do vídeo piloto é 19/10/2017 - Quinta-feira (Caso houver dúvidas sobre esse vídeo, leiam o 1º Resumo de Reunião)
...
## -> Achamos que seria uma boa ideia criar um "perfil" do Vue.js Brasil no Medium e abarcar os artigos feitos no blog oficial do Vue.js Brasil para a nova plataforma com a autorização dos autores
